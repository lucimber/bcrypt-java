...
/**
 * Represents the version of the BCrypt algorithm. BCrypt has different versions that handle certain
 * edge cases differently. The most common versions are 2a and 2b.
 */
public enum BCryptVersion {
    /**
     * Version 2a: The original secure version after fixing the 2 vulnerability. Some
     * implementations had a bug with handling non-ASCII characters.
     */
    VERSION_2A("2a"),

    /**
     * Version 2b: Fixed the handling of non-ASCII characters. This is the recommended version for
     * new applications.
     */
    VERSION_2B("2b");
