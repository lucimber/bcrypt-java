...
/**
 * Represents a BCrypt hash value object.
 * A BCrypt hash contains the algorithm version, cost factor, salt, and the actual hash value.
 * The standard format is: $version$cost$salt_and_hash
...
public final class Hash {
    ...
    public Hash(BCryptVersion version, CostFactor costFactor, String saltAndHash) {
        ...
        this.value = String.format("$%s$%02d$%s", 
            version.getPrefix(), costFactor.getValue(), saltAndHash);
    }
    ...
    /**
     * Gets the salt portion of the hash.
     * The salt is the first 22 characters of the saltAndHash.
     * 
    ...
    /**
     * Gets the hash portion (without salt).
     * The hash is the last 31 characters of the saltAndHash.
     * 
    ...
    /**
     * Checks if this hash matches a given password.
     * This is a convenience method that uses BCryptService internally.
     * 
