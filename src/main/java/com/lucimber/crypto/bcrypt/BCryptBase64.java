...
/**
 * BCrypt-specific Base64 encoding/decoding utility.
 * BCrypt uses a custom Base64 alphabet that differs from standard Base64.
 * The BCrypt alphabet is: ./ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789
 */
