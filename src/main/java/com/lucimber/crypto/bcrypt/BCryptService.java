...
/**
 * Service for BCrypt hashing and verification. This is the main entry point for BCrypt operations.
...
public class BCryptService {
    ...
    /**
     * Hashes a password using BCrypt with default settings. Uses version 2b and default cost
     * factor.
     *
    ...
    public Hash hash(Password password, BCryptVersion version, CostFactor costFactor, Salt salt) {
        ...
        String hashValue =
                BCryptEngine.hashpw(new String(password.getBytes()), saltString.toString());
