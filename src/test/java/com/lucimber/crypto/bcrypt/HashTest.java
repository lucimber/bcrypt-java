...
class HashTest {
    ...
    private static final String VALID_2A_HASH = "$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy";
    private static final String VALID_2B_HASH = "$2b$12$EXRkfkdmXnagzds2SSitu.MW9.gAVqa9eLS1//RYtYCmB1eLHg.9q";
    ...
    void shouldCreateHashFromComponents() {
        ...
        assertEquals("$2b$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy", hash.getValue());
    ...
    void shouldThrowExceptionForInvalidHashFormat() {
        // Missing $ prefix
        assertThrows(IllegalArgumentException.class, () -> new Hash("2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy"));
        
        // Invalid version
        assertThrows(IllegalArgumentException.class, () -> new Hash("$2c$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy"));
        
        // Invalid cost factor format
        assertThrows(IllegalArgumentException.class, () -> new Hash("$2a$1$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy"));
        
        // Too short salt and hash
        assertThrows(IllegalArgumentException.class, () -> new Hash("$2a$10$tooShort"));
        
        // Too long salt and hash
        assertThrows(IllegalArgumentException.class, () -> new Hash("$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWyExtra"));
    }
    ...
    void shouldThrowExceptionForIncorrectSaltAndHashLength() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new Hash(version, costFactor, "tooShort"));
        assertThrows(IllegalArgumentException.class, () -> new Hash(version, costFactor, "N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWyTooLong"));
    }
