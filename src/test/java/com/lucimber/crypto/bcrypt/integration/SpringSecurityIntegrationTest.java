...
class SpringSecurityIntegrationTest {
    ...
    void shouldVerifySpringSecurityGeneratedHash() {
        ...
        assertTrue(service.verify(password, hash),
            "Should verify hash generated by Spring Security");
    }
    ...
    void springSecurityShouldVerifyOurGeneratedHash() {
        ...
        assertTrue(springEncoder.matches(rawPassword, ourHash.getValue()),
    ...
    void shouldHandleDifferentCostFactorsLikeSpring() {
        ...
        for (int cost : costs) {
            ...
            assertEquals(cost, hash.getCostFactor().getValue(),
                "Cost factor should be " + cost);
            ...
            assertTrue(springWithCost.matches(rawPassword, ourHash.getValue()),
    ...
    void shouldHandle2aVersionLikeSpring() {
        ...
        // Verify it's 2a
        assertTrue(springHash.startsWith("$2a$"),
            "Spring should generate 2a hashes");
        ...
        assertTrue(service.verify(password, hash),
            "Should verify Spring's 2a hash");
        ...
        assertTrue(spring2a.matches(rawPassword, ourHash.getValue()),
            "Spring should verify our 2a hash");
    }
    ...
    void shouldHandle2bVersionCompatibility() {
        ...
        assertTrue(springEncoder.matches(rawPassword, our2bHash.getValue()),
    ...
    void shouldRejectWrongPasswordsLikeSpring() {
        ...
        assertFalse(service.verify(wrongPwd, hash),
            "Our implementation should reject wrong password");
        
        assertFalse(springEncoder.matches(wrongPassword, springHash),
        ...
        assertFalse(springEncoder.matches(wrongPassword, ourHash.getValue()),
    ...
    void crossValidationWithKnownTestVectors() {
        ...
        for (String[] vector : testVectors) {
            ...
            assertTrue(springEncoder.matches(rawPassword, knownHash),
